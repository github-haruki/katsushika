...
<head>
	...
	<title>signage</title>
	<link rel="stylesheet" href="contents2.css">
...
<body>
	<div class="signage">
		...
		<table style="width:50%">
			<tr>
				<td>11HR</td>
				<th id="cell11"><?= get_count('11') ?></th>
			</tr>
			<tr>
				<td>12HR</td>
				<th id="cell12"><?= get_count('12') ?></th>
			</tr>
			<tr>
				<td>13HR</td>
				<th id="cell13"><?= get_count('13') ?></th>
			</tr>
			<tr>
				<td>14HR</td>
				<th id="cell14"><?= get_count('14') ?></th>
			</tr>
			<tr>
				<td>15HR</td>
				<th id="cell15"><?= get_count('15') ?></th>
			</tr>
			<tr>
				<td>16HR</td>
				<th id="cell16"><?= get_count('16') ?></th>
			</tr>
			<tr>
				<td>17HR</td>
				<th id="cell17"><?= get_count('17') ?></th>
			</tr>
			<tr>
				<td></td>
				<th class="blank"></th>
			...
			<tr>
				<td>21HR</td>
				<th id="cell21"><?= get_count('21') ?></th>
			</tr>
			<tr>
				<td>22HR</td>
				<th id="cell22"><?= get_count('22') ?></th>
			</tr>
			<tr>
				<td>23HR</td>
				<th id="cell23"><?= get_count('23') ?></th>
			</tr>
			<tr>
				<td>24HR</td>
				<th id="cell24"><?= get_count('24') ?></th>
			</tr>
			<tr>
				<td>25HR</td>
				<th id="cell25"><?= get_count('25') ?></th>
			</tr>
			<tr>
				<td>26HR</td>
				<th id="cell26"><?= get_count('26') ?></th>
			</tr>
		</table>
	</div>
